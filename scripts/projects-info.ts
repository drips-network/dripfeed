...
if (!dbUrl) {
  ...
  console.error(`  tsx scripts/projects-info.ts [--db-url URL] [--schema SCHEMA]`);
  console.error();
  ...
  console.error(`  tsx scripts/projects-info.ts --db-url "postgresql://user:pass@host:5432/db"`);
  console.error(`  tsx scripts/projects-info.ts --db-url "postgresql://..." --schema filecoin`);
  process.exit(1);
}
