...
if (!dbUrl) {
  ...
  console.error();
  console.error(`${COLORS.CYAN}Usage: tsx scripts/projects-info.ts [db_url] [schema]${COLORS.NC}`);
  console.error();
  console.error(`${COLORS.CYAN}Examples:${COLORS.NC}`);
  console.error(`  tsx scripts/projects-info.ts`);
  console.error(`  tsx scripts/projects-info.ts "postgresql://user:pass@host:5432/db"`);
  console.error(`  tsx scripts/projects-info.ts "postgresql://user:pass@host:5432/db" filecoin`);
  console.error();
