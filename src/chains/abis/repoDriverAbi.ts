export const repoDriverAbi = [
  {
    inputs: [
      ...
      { internalType: 'contract IAutomate', name: 'gelatoAutomate_', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'userFundsUsed', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'commonFundsUsed', type: 'uint256' },
    ],
    name: 'GelatoFeePaid',
    type: 'event',
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint32', name: 'maxRequestsPerBlock', type: 'uint32' },
      { indexed: false, internalType: 'uint32', name: 'maxRequestsPer31Days', type: 'uint32' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'gelatoTasksOwner',
    outputs: [{ internalType: 'contract GelatoTasksOwner', name: 'tasksOwner', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  { inputs: [], name: 'unpause', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [
      ...
      { internalType: 'uint32', name: 'maxRequestsPerBlock', type: 'uint32' },
      { internalType: 'uint32', name: 'maxRequestsPer31Days', type: 'uint32' },
    ],
