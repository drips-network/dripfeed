...
export const cursor = pgTable('_cursor', {
  ...
  pending_reorg_validation_from_block: bigint('pending_reorg_validation_from_block', {
    mode: 'bigint',
  }),
  pending_reorg_validation_target_block: bigint('pending_reorg_validation_target_block', {
    mode: 'bigint',
  }),
